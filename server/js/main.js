...
(function () {
  ...
  // 中英文切换
  var chinaese = ['全球首条', '教育产业公有链', '教链 JLL', '白皮书', '教链 JLL', '首页', '白皮书', '联系我们', '团队', '中 / 英', '什么是教链（JLL）', '教链（JLL）是基于区块链技术的开源去中心化分布式教育产业协议。教链利用JLL智能协议，将区块链技术引入以教育行业，颠覆传统教育产业，打造全球首条教育公有链，其未来蓝图包括诸多教育领域分布式DAPP应用，一条教育产业公有链，一个人才内容去中心化交易所。', "教链（JLL）社区部落", "教链的整个生态由用户、认知讲堂、教链社区、挖矿和排行五大要素构成。用户构成教链社群，可以通过挖矿机制来获取教链代币，以及其他和教链有战略合作关系的其他项目代币。挖矿是教链代币获取的一种方式，也是整个生态的重要组成部分。在教链社区中，有很多有趣的共建方式：教师以认知讲堂作为其个人及其教学内容的展示平台，将自己的教学相关内容上传至认知讲堂，社群用户可以用代币来为喜欢的教学工作者及其内容投票，也可用代币对教师及其内容进行打赏。社群会依据投票情况，为教师及其所传内容进行排名，促进其获取用户打赏以及社群激励。", "教链（JLL）DAPP应用", "教师和教培机构通过JLL协议实现其各类教学内容，如课程、书籍、音频等的上链认证，教培机构可以通过JLL协议及其认证，发现并购买教师所提供的教学内容；人才也可以享受经JLL多样认证的、由教师和教培机构所提供的各类教学内容。所有的交易、培训及教学内容信息均由分布式账本进行数据存储，企业可向人才发出验证请求，获取其在平台上所记录的各类信息，获取其教育相关的全面画像，为其用人选聘提供决策支持。", "教链（JLL）内容交易所", "基于教师个人IP内容的认证、管理、孵化及与出版社、教育机构、资本等主体的版权交易等。当以上交易达到足够量时，教链内容交易所也可得到推行。", "教链（JLL）智能合约协议", "教链公有链智能协议为共识，以“人才”、“教师”、“资本”、“用户”为分布，通过JLL协议，将IP内容、人才和资本转化为数字资产，同时进行新币孵化、投票。在用户获得收益的同时，最大化IP内容、人才和资本的价值，帮助其在教链的人才及内容交易所和生态内获得流动性。", "JLL教链场景生态 ","教链JLL的生态建设从教育公链、内容交易、人才管理、版权保护、教育IP、教学服务、教育孵化和教育管理出发，利用分布式数据加密存储技术深度建设教链底层基础设施，打造一个去中心化的多方共赢教育新生态。","运营团队", '顾问团队', "敬请期待", "新闻头条", "EAST ENTRANCE", "合作伙伴"],
  ...
  "张振","首席产品设计官 品牌设计师 UI前端设计师","吴玉荣","Jason Wood","JLLchain教育基金会主席","张艾","数字货币天使投资人 币趣联合创始人 多家交易所顾问","梁凯恩","亚洲超级演说家 超越极限董事局主席","朱少平","原全国人大财经委法案主任 多部政策法律文件起草者","吴正宽",
"中国行销大师 超级演说家","石岩","中国十大策划讲师 品牌中国副秘书长 梦无缺工程创人","全栈开发工程师 区块链技术爱好者 数字货币早期持有者"],
...
"Content Operation Officer New media operation Former content writer of anAlibaba company","Zhang Zhen","Chief Product Design Officer Brand Designer","Wu Yurong","Jason Wood","Chairman of JLLchain Education Foundation",
...
"Full Stack Development Engineer Blockchain Technology Enthusiast Digital Currency Early Holder"],
    num = 30;
    for(var i = 0; i < num; i++) {
