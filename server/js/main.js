(function(){
  ...
  // 时钟
    function initicalClock(){
      var  clock_hours = document.getElementsByClassName('clock_hours')[0],clock_minutes = document.getElementsByClassName('clock_minutes')[0],
