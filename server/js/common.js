// 底部导航
var nav_goMainIcon = document.getElementsByClassName('nav_goMainIcon')[0],body = document.getElementsByClassName('body')[0],
...
classKu.addEvent(window,'scroll', classKu.throttel(function() {
  ...
  var smallScreenBtn = document.getElementsByClassName('smallScreenBtn')[0],smallBtnStep = true
...
//屏幕滚动 导航栏功能
var logoSvg = document.getElementsByClassName('logoSvg')[0],logoText = document.getElementsByClassName('logoText')[0],
...
smallScreenBtn = document.getElementsByClassName('smallScreenBtn')[0];
...
var chinese = ['首页','白皮书','联系我们','团队','中 / 英'],
    English = ['MAIN','WHITE PAPER','LIANXIWOMEK','TEAM','中 / 英'];
window.common = {
  svgNav: function (step) {
    if (step) {
      for(var i = 0; i < navListTextactive.length; i++) {
